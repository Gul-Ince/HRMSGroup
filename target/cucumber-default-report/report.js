...
formatter.feature({
  ...
  "description": "   Description: This feature tests and verifies Syntax HRMS Web Service\n   The workflow consists of the following sequential calls",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@workflow"
...
formatter.step({
  "name": "a GET call is made to retrieve the craeted employee",
  "keyword": "When "
});
formatter.match({
  "location": "com.hrms.API.steps.Practice.WorkflowAllSteps.a_GET_call_is_made_to_retrieve_the_craeted_employee()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "the retrieved employee ID at \"employee[0].employee_id\" matches the globally restored employee ID",
  "keyword": "And "
});
formatter.match({
  "location": "com.hrms.API.steps.Practice.WorkflowAllSteps.the_retrieved_employee_ID_at_matches_the_globally_restored_employee_ID(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
